        ...
        <div class="collapse navbar-collapse" id="navbarHeader">
          ...
          <div>
            ...
            <?php if (isset($_SESSION['user_id'])) { ?>
              <a href="#" class="btn btn-primary" name="login"> <i class="bi bi-person"></i> <svg
            ...
            <?php } else {?>
              ...
              <a href="registro.php" class="btn btn-primary" name="registrarse"> <i class="bi bi-person-add"></i> <svg
